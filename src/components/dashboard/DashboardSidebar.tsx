...
import { LucideIcon, LogOut, UserCircle2 } from "lucide-react";
        ...
        <aside className="fixed left-0 top-0 h-full w-72 flex flex-col z-40" style={{ background: "#0D2D5A" }}>
            ...
            <div className="px-3 py-5 border-t border-white/10 bg-black/10">
                ...
                <button
                    ...
                    className="group w-full flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-widest text-blue-300/60 hover:text-white hover:bg-red-500/10 transition-all duration-300"
                >
